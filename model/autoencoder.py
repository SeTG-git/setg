from .gat import GAT
from util.utils import create_norm
...
class GMAEModel(nn.Module):
    ...
    def compute_loss(self, g):
        ...
        if threshold < g.number_of_edges() and g.number_of_edges()>10:
            negative_edge_pairs = dgl.sampling.global_uniform_negative_sampling(g, threshold//2+1)
