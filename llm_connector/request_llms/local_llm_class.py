import time
import threading
from llm_connector.toolbox.toolbox import update_ui, Singleton
from multiprocessing import Process, Pipe
from contextlib import redirect_stdout
from llm_connector.request_llms.queued_pipe import create_queue_pipe
...
class LocalLLMHandle(Process):
    ...
    def run(self):
        ...
        try:
            ...
            self.running = False
            from llm_connector.toolbox.toolbox import trimmed_format_exc
            self.child.send(
