...
if USE_PROXY:
    ...
    proxies = {
        #          [协议]://  [地址]  :[端口]
        "http":  "socks5h://10.177.35.137:7890",  # 再例如  "http":  "http://127.0.0.1:7890",
        "https": "socks5h://10.177.35.137:7890",  # 再例如  "https": "http://127.0.0.1:7890",
    }
else:
    proxies = None
...
AVAIL_LLM_MODELS = ["qwen-local","gpt-4-1106-preview", "gpt-4-turbo-preview", "gpt-4-vision-preview",
...
INIT_SYS_PROMPT = "Serve me as a mobile scamware detection master."
...
# QWEN_LOCAL_MODEL_SELECTION = "Qwen/Qwen1.5-72B-Chat"
QWEN_LOCAL_MODEL_SELECTION = "Qwen/Qwen1.5-4B-Chat"
