import time
import threading
from origin_academic.toolbox.toolbox import update_ui, Singleton
from multiprocessing import Process, Pipe
from contextlib import redirect_stdout
from origin_academic.request_llms.queued_pipe import create_queue_pipe
...
class LocalLLMHandle(Process):
    ...
    def run(self):
        ...
        try:
            ...
            self.running = False
            from origin_academic.toolbox.toolbox import trimmed_format_exc
            self.child.send(
...
def get_local_llm_predict_fns(LLMSingletonClass, model_name, history_format='classic'):
    ...
    def predict_no_ui_long_connection(inputs, llm_kwargs, history=[], sys_prompt="", observe_window=[], console_slience=False,index = None):
        """
