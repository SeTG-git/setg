...
def get_plugin_default_kwargs():
    ...
    """
    from data.origin_academic.toolbox.toolbox import ChatBotWithCookies, load_chat_cookies
...
def get_chat_default_kwargs():
    ...
    """
    from data.origin_academic.toolbox.toolbox import load_chat_cookies
