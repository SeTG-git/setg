from origin_academic.toolbox.toolbox import update_ui, get_conf, trimmed_format_exc, get_max_token, Singleton
import threading
import os
import logging
...
def request_gpt_model_in_new_thread(
    ...
    from origin_academic.request_llms.bridge_all import predict_no_ui_long_connection
    # 用户反馈
        ...
        while True:
            ...
            try:
                ...
                if handle_token_exceed:
                    ...
                    from origin_academic.toolbox.toolbox import get_reduce_token_percent
        ...
        while True:
            ...
            try:
                ...
                if handle_token_exceed:
                    exceeded_cnt += 1
                    # 【选择处理】 尝试计算比例，尽可能多地保留文本
                    from data.origin_academic.toolbox.toolbox import get_reduce_token_percent
                    p_ratio, n_exceed = get_reduce_token_percent(str(token_exceeded_error))
                    MAX_TOKEN = get_max_token(llm_kwargs)
                    EXCEED_ALLO = 512 + 512 * exceeded_cnt
                    inputs, history = input_clipping(inputs, history, max_token_limit=MAX_TOKEN-EXCEED_ALLO)
...
def get_files_from_everything(txt, type): # type='.md'
    ...
    if txt.startswith('http'):
        # 网络的远程文件
        import requests
        from data.origin_academic.toolbox.toolbox import get_conf
        from data.origin_academic.toolbox.toolbox import get_log_folder, gen_time_str
...
class nougat_interface():
    ...
    def nougat_with_timeout(self, command, cwd, timeout=3600):
        import subprocess
        from data.origin_academic.toolbox.toolbox import ProxyNetworkActivate
    ...
    def NOUGAT_parse_pdf(self, fp, chatbot, history):
        from data.origin_academic.toolbox.toolbox import update_ui_lastest_msg
